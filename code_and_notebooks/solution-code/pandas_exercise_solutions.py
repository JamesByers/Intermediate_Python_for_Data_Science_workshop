...
drinks = pd.read_table('https://github.com/JamesByers/Datasets/raw/master/drinks.csv', sep=',')
drinks = pd.read_csv('https://github.com/JamesByers/Datasets/raw/master/drinks.csv')              # assumes separator is comma
...
users = pd.read_table('https://github.com/JamesByers/Datasets/raw/master/u.user', sep='|', index_col='user_id', header=1, names=user_cols, )
...
ufo = pd.read_table('https://github.com/JamesByers/Datasets/raw/master/ufo.csv', sep=',')
ufo = pd.read_csv('https://github.com/JamesByers/Datasets/raw/master/ufo.csv')
